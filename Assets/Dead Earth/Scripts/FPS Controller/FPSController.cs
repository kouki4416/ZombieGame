...
public class FPSController : MonoBehaviour 
{
	...
	[SerializeField] private float _staminaDepletoin    = 5.0f;
	...
	private bool _freezeMovement = false; //Character movement freeze
	...
	protected void Update()
	{
		...
		if (_movementStatus == PlayerMoveStatus.Running)
			_stamina = Mathf.Max(_stamina - _staminaDepletoin * Time.deltaTime, 0.0f);
		else
